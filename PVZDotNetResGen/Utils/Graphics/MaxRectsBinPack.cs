...
namespace PVZDotNetResGen.Utils.Graphics
{
    public class MaxRectsBinPack
    {
        ...
        private List<BinRect> usedRectangles = new List<BinRect>();
        private List<BinRect> freeRectangles = new List<BinRect>();
        ...
        public BinRect Insert(int width, int height, FreeRectChoiceHeuristic method)
        {
        ...
        public void Insert(List<BinRect> rects, List<BinRect> dst, FreeRectChoiceHeuristic method)
        {
            dst.Clear();
            ...
            while (rects.Count > 0)
            {
                ...
                for (int i = 0; i < rects.Count; ++i)
                {
                    int score1 = 0;
                    int score2 = 0;
                    BinRect newNode = ScoreRect((int)rects[i].width, (int)rects[i].height, method, ref score1, ref score2);
                ...
                PlaceRect(bestNode);
                dst.Add(new BinRect { x = bestNode.x, y = bestNode.y, width = bestNode.width, height = bestNode.height, id = rects[bestRectIndex].id });
                rects.RemoveAt(bestRectIndex);
            }
        }

        private void PlaceRect(BinRect node)
        {
            int numRectanglesToProcess = freeRectangles.Count;
            for (int i = 0; i < numRectanglesToProcess; ++i)
            {
        ...
        private BinRect ScoreRect(int width, int height, FreeRectChoiceHeuristic method, ref int score1, ref int score2)
        {
            BinRect newNode = new BinRect();
            score1 = int.MaxValue;
            score2 = int.MaxValue;
        ...
        private BinRect FindPositionForNewNodeBottomLeft(int width, int height, ref int bestY, ref int bestX)
        {
            BinRect bestNode = new BinRect();
        ...
        private BinRect FindPositionForNewNodeBestShortSideFit(int width, int height, ref int bestShortSideFit, ref int bestLongSideFit)
        {
            BinRect bestNode = new BinRect();
            //memset(&bestNode, 0, sizeof(Rect));
        ...
        private BinRect FindPositionForNewNodeBestLongSideFit(int width, int height, ref int bestShortSideFit, ref int bestLongSideFit)
        {
            BinRect bestNode = new BinRect();
            //memset(&bestNode, 0, sizeof(Rect));
        ...
        private BinRect FindPositionForNewNodeBestAreaFit(int width, int height, ref int bestAreaFit, ref int bestShortSideFit)
        {
            BinRect bestNode = new BinRect();
            //memset(&bestNode, 0, sizeof(Rect));
        ...
        private BinRect FindPositionForNewNodeContactPoint(int width, int height, ref int bestContactScore)
        {
            BinRect bestNode = new BinRect();
            //memset(&bestNode, 0, sizeof(Rect));
        ...
        private bool IsContainedIn(BinRect a, BinRect b)
        {
